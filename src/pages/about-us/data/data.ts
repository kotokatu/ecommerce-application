export const developersData = [
  ...
  },
  {
    ...
    name: 'Maxim',
    description:
      'I began to be interested in programming a very long time ago. A year ago I found Rss courses and decided to try to participate in them. Currently, my goal is to connect myself with the world of programming, learn new technologies and find my first job. I have good interpersonal skills, am an excellent team worker and am eager to learn and develop new skills.',
    conclusion: "I am grateful to RSS School for the courses. And now I'm ready to start realizing my goal.",
  },
  {
    greeting: 'Hey there!',
    name: 'Victoriia',

...
export const validation = {
  ...
  firstName: (value: string) =>
    /^[a-zA-Z]+$/.test(value) ? null : 'First name should only contain letters and cannot be empty',
  lastName: (value: string) =>
    /^[a-zA-Z]+$/.test(value) ? null : 'Last name should only contain letters and cannot be empty',
  ...
  city: (value: string) => (/^[a-zA-Z]+$/.test(value) ? null : 'City should only contain letters and cannot be empty'),
